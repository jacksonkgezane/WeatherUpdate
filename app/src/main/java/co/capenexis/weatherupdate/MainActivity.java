package co.capenexis.weatherupdate;
...
import com.capenexis.weatherupdate.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    class weatherTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String args[]) {
            String response = HttpRequest.excuteGet("https://api.openweathermap.org/data/2.5/weather?q="+CITY1+"&units=metric&appid=40b89883228ac7a1cc6c2fa70298afa6");
            return response;
        }
